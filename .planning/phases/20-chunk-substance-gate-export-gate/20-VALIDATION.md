...
- **After every task commit:** Run `pytest tests/unit/test_chunk_substance_gate.py tests/unit/test_chunk_storage.py tests/unit/test_export.py tests/unit/test_datasets.py tests/test_must_not_reject.py -x`
...
| 20-02-01 | 02 | TBD | MEAS-02 | V5 | ~20 must-not-reject fixtures (ICD/LOINC/RxNorm/HIPAA/dosage/cardinality) never dropped by the gate | unit (parametrized) | `pytest tests/test_must_not_reject.py -x` | ❌ W0 | ⬜ pending |
