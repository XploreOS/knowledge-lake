...
- [x] 12-02-PLAN.md — extract process_crawled/list_sources/stats/load_domain + count_points; refactor CLI/API callers
- [x] 12-03-PLAN.md — schema source-of-truth: extend SearchParams + new tool input models
- [x] 12-04-PLAN.md — fd-level stdout-lockdown shim + self-test (first-task gate, stdio only)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 12-05-PLAN.md — McpSettings + tool registry (ToolDef/TOOLS) + low-level MCP server core
...
- [x] 12-07-PLAN.md — klake mcp (stdio/--sse) + klake openapi + OpenAI tool defs; committed docs/openapi.json & docs/openai_tools.json
