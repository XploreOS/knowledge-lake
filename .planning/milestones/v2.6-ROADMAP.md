...
- [x] 21-03-PLAN.md — VectorStorePlugin.set_payload protocol + QdrantVectorStore implementation (DEDUP-03)
...
- [x] 21-05-PLAN.md — index() duplicate_chunks kwarg: contributor append, capped payload mirror, self-heal (DEDUP-02, DEDUP-03)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 21-06-PLAN.md — Wire dedup_chunks() into process_crawled() (CLI/API/MCP path) (DEDUP-01)
- [x] 21-07-PLAN.md — Wire dedup_chunks Dagster asset + core_pipeline_e2e_job selection update (DEDUP-01)

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 21-08-PLAN.md — CLI/Dagster parity test + reindex-survives-dedup integration test (DEDUP-01, DEDUP-02, DEDUP-03)
...
| 22 | Address tech debt: measure garbage/junk rates end-to-end | 3/3 | Complete    | 2026-07-18 |
...
- [x] 22-02-PLAN.md — klake quality-audit --full CLI flag, dual table/JSON output (MEAS-01)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 22-03-PLAN.md — Real measurement run against the live 34-source healthcare corpus; Nyquist reconciliation logged as operator follow-up (MEAS-01, EXPORT-01)
