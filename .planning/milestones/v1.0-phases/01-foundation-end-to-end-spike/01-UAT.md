...
result: pass
notes: 12/12 tests passing with KLAKE_STORAGE__* env vars set; bucket bootstrapped via ensure_buckets()
...
result: pass
notes: 44/44 integration tests passing (test_lineage.py + test_api_lineage.py)
